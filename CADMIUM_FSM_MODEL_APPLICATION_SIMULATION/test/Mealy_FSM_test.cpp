...
* Carleton University
*
* Test for MealyFSM Atomic Model
**************************************************************/
...
int main(int argc, char ** argv) {
    ...
    /****** MealyFSM atomic model instantiation *******************/
    shared_ptr<dynamic::modeling::model> MealyFSM1;
    MealyFSM1 = dynamic::translate::make_dynamic_atomic_model<MealyFSM, TIME>("MealyFSM1","Idle", "active", true, fsm_callback_event,fsm_callback_transition);
    ...
    submodels_TOP = {input_reader_EventIn,input_reader_TransitionIn, MealyFSM1};
    dynamic::modeling::EICs eics_TOP;
    eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP;
    eocs_TOP = {
        dynamic::translate::make_EOC<MealyFSM_defs::transitionOut,top_out>("MealyFSM1"),
	dynamic::translate::make_EOC<MealyFSM_defs::stateOutput,top_out>("MealyFSM1"),
	dynamic::translate::make_EOC<MealyFSM_defs::errorOut,top_out>("MealyFSM1")	
    };
    dynamic::modeling::ICs ics_TOP;
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<string>::out,MealyFSM_defs::eventIn>("input_reader_EventIn","MealyFSM1"),
	dynamic::translate::make_IC<iestream_input_defs<string>::out,MealyFSM_defs::transitionIn>("input_reader_TransitionIn","MealyFSM1")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/MealyFSM_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/MealyFSM_test_output_state.txt");
